...
class Navier_Stokes(torch_fenics.FEniCSModule):
    ...
    def __init__(self):
        ...
        self.T = 10.0           # final time
        self.num_steps = 125   # number of time steps
    ...
    def solve(self,beta):
        ...
        F1 = beta*dot((u - u_n) / k, v)*dx + \
            beta*dot(dot(u_n, nabla_grad(u_n)), v)*dx \
    ...
    def input_templates(self):
        ...
        return Constant(0)#Constant(np.repeat(0,2601)), Constant(0)
